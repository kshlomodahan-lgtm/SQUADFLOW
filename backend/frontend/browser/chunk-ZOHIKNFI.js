...
function ShellComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "span", 21);
    \u0275\u0275text(2, "SQUAD");
    \u0275\u0275elementEnd();
...
function ShellComponent_For_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(group_r1.label);
  }
}
function ShellComponent_For_7_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_For_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 25)(1, "mat-icon");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ShellComponent_For_7_For_2_Conditional_3_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.sidebarOpen ? 3 : -1);
  }
}
function ShellComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ShellComponent_For_7_Conditional_0_Template, 2, 1, "div", 24);
    \u0275\u0275repeaterCreate(1, ShellComponent_For_7_For_2_Template, 4, 4, "a", 25, _forTrack2);
  }
  if (rf & 2) {
    const group_r1 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.sidebarOpen ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(group_r1.items);
  }
}
function ShellComponent_For_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 26);
    \u0275\u0275listener("click", function ShellComponent_For_20_Template_button_click_0_listener() {
      const s_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.theme.setScheme(s_r5.id));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275classProp("active", ctx_r2.theme.scheme() === s_r5.id);
...
var ShellComponent = class _ShellComponent {
  ...
  static \u0275fac = function ShellComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ShellComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ThemeService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], decls: 37, vars: 9, consts: [[1, "shell"], [1, "sidebar"], [1, "sidebar-brand"], [1, "brand-logo"], [1, "sidebar-nav"], [1, "sidebar-footer"], ["mat-icon-button", "", 3, "click", "matTooltip"], ["mat-icon-button", "", "matTooltip", "\u05D4\u05EA\u05E0\u05EA\u05E7", 3, "click"], [1, "main-area"], [1, "topbar"], [1, "topbar-start"], [1, "scheme-picker"], [1, "scheme-dot", 3, "background", "active", "title"], [1, "topbar-sep"], [1, "topbar-btn", 3, "click", "title"], [1, "topbar-icon"], [1, "topbar-end"], [1, "user-chip"], [1, "user-avatar"], [1, "user-name"], [1, "page-content"], [1, "sq"], [1, "fl"], [1, "brand-tagline"], [1, "nav-group-label"], ["routerLinkActive", "active", "matTooltipPosition", "after", 1, "nav-item", 3, "routerLink", "matTooltip"], [1, "scheme-dot", 3, "click", "title"]], template: function ShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(6, ShellComponent_For_7_Template, 3, 1, null, null, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 5)(9, "button", 6);
      \u0275\u0275listener("click", function ShellComponent_Template_button_click_9_listener() {
      ...
      \u0275\u0275listener("click", function ShellComponent_Template_button_click_12_listener() {
        return ctx.logout();
      });
      \u0275\u0275elementStart(13, "mat-icon");
      \u0275\u0275text(14, "logout");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(15, "div", 8)(16, "header", 9)(17, "div", 10)(18, "div", 11);
      \u0275\u0275repeaterCreate(19, ShellComponent_For_20_Template, 1, 5, "button", 12, _forTrack1);
      \u0275\u0275elementEnd();
      \u0275\u0275element(21, "div", 13);
      ...
      \u0275\u0275text(26, "notifications_none");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "mat-icon", 15);
      \u0275\u0275text(28, "help_outline");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(29, "div", 16)(30, "div", 17)(31, "div", 18);
      \u0275\u0275text(32);
      \u0275\u0275elementEnd();
...
`, styles: ["/* src/app/shell/shell.component.scss */\n:host {\n  display: block;\n  height: 100vh;\n}\n.shell {\n  display: grid;\n  grid-template-columns: 220px 1fr;\n  grid-template-rows: 1fr;\n  height: 100vh;\n  direction: rtl;\n  transition: grid-template-columns 0.22s ease;\n}\n.shell.sidebar-closed {\n  grid-template-columns: 56px 1fr;\n}\n.sidebar {\n  background: var(--sf-bg-card);\n  border-left: 1px solid var(--sf-border);\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  z-index: 10;\n}\n.sidebar-brand {\n  padding: 18px 16px 14px;\n  border-bottom: 1px solid var(--sf-border);\n  white-space: nowrap;\n}\n.brand-logo {\n  font-size: 1.25rem;\n  font-weight: 900;\n  letter-spacing: -0.5px;\n  line-height: 1;\n  direction: ltr;\n}\n.brand-logo .sq {\n  color: var(--sf-text);\n}\n.brand-logo .fl {\n  color: var(--sf-primary);\n}\n.brand-tagline {\n  font-size: 0.65rem;\n  color: var(--sf-text-muted);\n  margin-top: 3px;\n  letter-spacing: 0.2px;\n}\n.sidebar-nav {\n  flex: 1;\n  padding: 10px 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 1px;\n  overflow-y: auto;\n}\n.nav-group-label {\n  font-size: 0.68rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.06em;\n  color: var(--sf-text-muted);\n  padding: 10px 10px 4px;\n  margin-top: 4px;\n}\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 8px 10px;\n  border-radius: 8px;\n  color: var(--sf-text-secondary);\n  text-decoration: none;\n  font-size: 0.875rem;\n  font-weight: 500;\n  white-space: nowrap;\n  transition: background 0.13s, color 0.13s;\n}\n.nav-item mat-icon {\n  font-size: 19px;\n  width: 19px;\n  height: 19px;\n  flex-shrink: 0;\n}\n.nav-item:hover {\n  background: var(--sf-bg-hover);\n  color: var(--sf-text);\n}\n.nav-item.active {\n  background: var(--sf-primary-light);\n  color: var(--sf-primary);\n  font-weight: 600;\n}\n.sidebar-footer {\n  padding: 10px 8px;\n  border-top: 1px solid var(--sf-border);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.sidebar-footer button {\n  color: var(--sf-text-muted);\n}\n.sidebar-footer button:hover {\n  color: var(--sf-text);\n}\n.main-area {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  background: var(--sf-bg);\n}\n.topbar {\n  height: 52px;\n  flex-shrink: 0;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0 24px;\n  background: var(--sf-bg-card);\n  border-bottom: 1px solid var(--sf-border);\n}\n.topbar-start {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.topbar-end {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.topbar-icon {\n  color: var(--sf-text-muted);\n  cursor: pointer;\n  font-size: 20px;\n}\n.topbar-icon:hover {\n  color: var(--sf-text);\n}\n.topbar-btn {\n  background: none;\n  border: none;\n  cursor: pointer;\n  width: 34px;\n  height: 34px;\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: var(--sf-text-muted);\n  transition: background 0.13s, color 0.13s;\n}\n.topbar-btn mat-icon {\n  font-size: 20px;\n  width: 20px;\n  height: 20px;\n}\n.topbar-btn:hover {\n  background: var(--sf-bg-hover);\n  color: var(--sf-text);\n}\n.scheme-picker {\n  display: flex;\n  align-items: center;\n  gap: 5px;\n}\n.scheme-dot {\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  border: 2px solid transparent;\n  outline: 2px solid transparent;\n  outline-offset: 1px;\n  cursor: pointer;\n  padding: 0;\n  transition: transform 0.15s, outline-color 0.15s;\n}\n.scheme-dot:hover {\n  transform: scale(1.2);\n}\n.scheme-dot.active {\n  outline-color: var(--sf-text);\n  transform: scale(1.1);\n}\n.topbar-sep {\n  width: 1px;\n  height: 20px;\n  background: var(--sf-border);\n  margin: 0 4px;\n}\n.user-chip {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  padding: 4px 10px 4px 4px;\n  border-radius: 20px;\n  cursor: pointer;\n  transition: background 0.13s;\n}\n.user-chip:hover {\n  background: var(--sf-bg-hover);\n}\n.user-avatar {\n  width: 28px;\n  height: 28px;\n  border-radius: 50%;\n  background: var(--sf-primary);\n  color: #fff;\n  font-size: 0.75rem;\n  font-weight: 700;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.user-name {\n  font-size: 0.83rem;\n  font-weight: 600;\n  color: var(--sf-text);\n}\n.page-content {\n  flex: 1;\n  overflow-y: auto;\n  overflow-x: hidden;\n  padding: 24px 28px;\n  display: flex;\n  flex-direction: column;\n}\n.page-content > * {\n  width: 100%;\n  min-width: 0;\n}\n/*# sourceMappingURL=shell.component.css.map */\n"] }]
  }], () => [{ type: AuthService }, { type: ThemeService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShellComponent, { className: "ShellComponent", filePath: "src/app/shell/shell.component.ts", lineNumber: 24 });
})();
export {
  ShellComponent
};
//# sourceMappingURL=chunk-ZOHIKNFI.js.map
