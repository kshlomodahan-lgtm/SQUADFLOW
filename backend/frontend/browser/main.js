...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-DCC2C5ZP.js").then((m7) => m7.LoginComponent)
  },
  {
    path: "app",
    loadComponent: () => import("./chunk-ZOHIKNFI.js").then((m7) => m7.ShellComponent),
    canActivate: [authGuard],
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-FT46CZLH.js").then((m7) => m7.DashboardComponent)
      },
      {
        path: "organizations",
        loadComponent: () => import("./chunk-2RZT7IZD.js").then((m7) => m7.OrganizationsComponent)
      },
      {
        path: "users",
        loadComponent: () => import("./chunk-CSUQH3P4.js").then((m7) => m7.UsersComponent)
      },
      {
        path: "categories",
        loadComponent: () => import("./chunk-D7UZORMJ.js").then((m7) => m7.CategoriesComponent)
      },
      {
        path: "products",
        loadComponent: () => import("./chunk-EN6ZBXG3.js").then((m7) => m7.ProductsComponent)
      },
      {
        path: "packages",
        loadComponent: () => import("./chunk-ZGMYRIXF.js").then((m7) => m7.PackagesComponent)
      },
      {
        path: "settings",
        loadComponent: () => import("./chunk-N5XRIGQU.js").then((m7) => m7.SettingsComponent)
      },
      {
        path: "audit",
        loadComponent: () => import("./chunk-EJZWDORZ.js").then((m7) => m7.AuditComponent)
      },
      {
        path: "audit/action-types",
        loadComponent: () => import("./chunk-JNBSKDQ5.js").then((m7) => m7.AuditActionTypesComponent)
      },
      {
        path: "audit/entity-types",
        loadComponent: () => import("./chunk-SUAENMAS.js").then((m7) => m7.AuditEntityTypesComponent)
      }
    ]
  },
