...
function CategoriesComponent_button_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 16);
    \u0275\u0275listener("click", function CategoriesComponent_button_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openAdd());
    });
    \u0275\u0275text(1, " \u05E7\u05D8\u05D2\u05D5\u05E8\u05D9\u05D4 \u05D7\u05D3\u05E9\u05D4 ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function CategoriesComponent_Conditional_21_ng_template_9_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(row_r4.IconName);
  }
}
function CategoriesComponent_Conditional_21_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(11, CategoriesComponent_Conditional_21_ng_template_9_Conditional_11_Template, 5, 1, "div", 37);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r4.ColorHex);
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r4.IconName ? 11 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(row_r4.SortOrder);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(row_r4.TenantID === 0 ? "\u05E7\u05D8\u05D2\u05D5\u05E8\u05D9\u05D9\u05EA \u05E4\u05DC\u05D8\u05E4\u05D5\u05E8\u05DE\u05D4" : "\u05E7\u05D8\u05D2\u05D5\u05E8\u05D9\u05D9\u05EA \u05D0\u05E8\u05D2\u05D5\u05DF");
  }
}
...
function CategoriesComponent_Conditional_21_ng_template_13_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(row_r6.TenantName);
  }
}
function CategoriesComponent_Conditional_21_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CategoriesComponent_Conditional_21_ng_template_13_Conditional_0_Template, 2, 0, "span", 44)(1, CategoriesComponent_Conditional_21_ng_template_13_Conditional_1_Template, 2, 1, "span", 45);
  }
  if (rf & 2) {
    const row_r6 = ctx.$implicit;
    \u0275\u0275conditional(row_r6.TenantID === 0 ? 0 : 1);
  }
}
function CategoriesComponent_Conditional_21_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "code", 46);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(row_r7.CategoryCode);
  }
}
function CategoriesComponent_Conditional_21_ng_template_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(row_r8.ProductCount);
  }
}
...
function CategoriesComponent_Conditional_21_ng_template_22_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 56);
    \u0275\u0275listener("click", function CategoriesComponent_Conditional_21_ng_template_22_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r14);
      const row_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleActive(row_r12));
    });
    \u0275\u0275element(1, "i", 53);
    \u0275\u0275elementEnd();
  }
...
function CategoriesComponent_Conditional_21_ng_template_22_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 57);
    \u0275\u0275listener("click", function CategoriesComponent_Conditional_21_ng_template_22_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r15);
      const row_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openEdit(row_r12));
    });
    \u0275\u0275element(1, "i", 58);
    \u0275\u0275elementEnd();
  }
...
function CategoriesComponent_Conditional_21_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CategoriesComponent_Conditional_21_ng_template_22_Template_button_click_1_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleDetail(row_r12.CategoryID, rowIndex_r13));
    });
    \u0275\u0275element(2, "i", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, CategoriesComponent_Conditional_21_ng_template_22_button_3_Template, 2, 9, "button", 54)(4, CategoriesComponent_Conditional_21_ng_template_22_button_4_Template, 2, 0, "button", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275classProp("expanded", ctx_r1.isExpanded(row_r12.CategoryID));
    \u0275\u0275property("title", ctx_r1.isExpanded(row_r12.CategoryID) ? "\u05E1\u05D2\u05D5\u05E8" : "\u05E4\u05E8\u05D8\u05D9\u05DD");
    \u0275\u0275advance();
    \u0275\u0275classProp("pi-chevron-down", !ctx_r1.isExpanded(row_r12.CategoryID))("pi-chevron-up", ctx_r1.isExpanded(row_r12.CategoryID));
    \u0275\u0275advance();
    \u0275\u0275property("appHasPerm", "CATALOG_CATEGORIES:UPDATE");
    \u0275\u0275advance();
    \u0275\u0275property("appHasPerm", "CATALOG_CATEGORIES:UPDATE");
  }
}
function CategoriesComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "kendo-excelexport-column", 21)(4, "kendo-excelexport-column", 22)(5, "kendo-excelexport-column", 23)(6, "kendo-excelexport-column", 24)(7, "kendo-excelexport-column", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "kendo-grid-messages", 26);
    \u0275\u0275template(9, CategoriesComponent_Conditional_21_ng_template_9_Template, 22, 6, "ng-template", 27);
    \u0275\u0275elementStart(10, "kendo-grid-column", 28);
    \u0275\u0275template(11, CategoriesComponent_Conditional_21_ng_template_11_Template, 4, 3, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "kendo-grid-column", 30);
    \u0275\u0275template(13, CategoriesComponent_Conditional_21_ng_template_13_Template, 2, 1, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "kendo-grid-column", 21);
    \u0275\u0275template(15, CategoriesComponent_Conditional_21_ng_template_15_Template, 2, 1, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "kendo-grid-column", 23);
    \u0275\u0275template(17, CategoriesComponent_Conditional_21_ng_template_17_Template, 2, 1, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "kendo-grid-column", 24);
    \u0275\u0275elementStart(19, "kendo-grid-column", 31);
    \u0275\u0275template(20, CategoriesComponent_Conditional_21_ng_template_20_Template, 4, 5, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "kendo-grid-column", 32);
    \u0275\u0275template(22, CategoriesComponent_Conditional_21_ng_template_22_Template, 5, 9, "ng-template", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("data", \u0275\u0275pureFunction2(27, _c0, ctx_r1.pagedData, ctx_r1.gridData.length))("skip", ctx_r1.skip)("pageSize", ctx_r1.pageSize)("pageable", \u0275\u0275pureFunction1(31, _c2, \u0275\u0275pureFunction0(30, _c1)))("sortable", \u0275\u0275pureFunction0(33, _c3))("sort", ctx_r1.sort)("reorderable", true)("resizable", true)("columnMenu", true);
    \u0275\u0275advance();
...
function CategoriesComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-category-dialog", 59);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("cat", ctx_r1.dialogCat());
  }
}
var CategoriesComponent = class _CategoriesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CategoriesComponent, selectors: [["app-categories"]], viewQuery: function CategoriesComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(6);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(7, CategoriesComponent_button_7_Template, 2, 1, "button", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 4)(9, "div", 5)(10, "mat-icon", 6);
      \u0275\u0275text(11, "search");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "input", 7);
      \u0275\u0275listener("input", function CategoriesComponent_Template_input_input_12_listener($event) {
      ...
      \u0275\u0275listener("click", function CategoriesComponent_Template_button_click_16_listener() {
        return ctx.exportPDF();
      });
      \u0275\u0275text(17, "PDF");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(18, "div", 11);
      \u0275\u0275conditionalCreate(19, CategoriesComponent_Conditional_19_Template, 2, 0, "div", 12);
      \u0275\u0275conditionalCreate(20, CategoriesComponent_Conditional_20_Template, 2, 1, "div", 13);
      \u0275\u0275conditionalCreate(21, CategoriesComponent_Conditional_21_Template, 23, 34, "kendo-grid", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(22, CategoriesComponent_Conditional_22_Template, 1, 1, "app-category-dialog", 15);
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1("", ctx.cats().length, " \u05E7\u05D8\u05D2\u05D5\u05E8\u05D9\u05D5\u05EA \u05D1\u05DE\u05E2\u05E8\u05DB\u05EA");
      \u0275\u0275advance();
      \u0275\u0275property("appHasPerm", "CATALOG_CATEGORIES:CREATE");
      \u0275\u0275advance(7);
...
(() => {
  ...
  <div class="page-header">
    ...
    <button *appHasPerm="'CATALOG_CATEGORIES:CREATE'"
      ...
      <kendo-grid-column title="" [width]="104" [sortable]="false" [resizable]="false" [columnMenu]="false">
        <ng-template kendoGridCellTemplate let-row let-rowIndex="rowIndex">
          <div class="row-actions">
            ...
            <button *appHasPerm="'CATALOG_CATEGORIES:UPDATE'"
                    class="act-btn"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoriesComponent, { className: "CategoriesComponent", filePath: "src/app/features/catalog/categories/categories.component.ts", lineNumber: 28 });
})();
export {
  CategoriesComponent
};
//# sourceMappingURL=chunk-FNGUBVG6.js.map
