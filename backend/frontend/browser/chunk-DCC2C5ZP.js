...
var TenantService = class _TenantService {
  ...
  getPublicInfo(tenantCode) {
    return this.http.get(`/api/public/tenant/${tenantCode}`).pipe(catchError(() => of({
      success: false,
...
function LoginComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 35);
    \u0275\u0275text(2, "\u26A0");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3");
    \u0275\u0275text(4, "\u05E7\u05D9\u05E9\u05D5\u05E8 \u05DC\u05D0 \u05EA\u05E7\u05D9\u05DF");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "\u05E4\u05E0\u05D4 \u05DC\u05DE\u05E0\u05D4\u05DC \u05D4\u05DE\u05E2\u05E8\u05DB\u05EA \u05DC\u05E7\u05D1\u05DC\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8 \u05DB\u05E0\u05D9\u05E1\u05D4 \u05DC\u05D0\u05E8\u05D2\u05D5\u05DF \u05E9\u05DC\u05DA.");
    \u0275\u0275elementEnd()();
  }
}
function LoginComponent_Conditional_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 36);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("src", ctx_r1.tenant().logoUrl, \u0275\u0275sanitizeUrl)("alt", ctx_r1.tenant().companyName);
  }
}
function LoginComponent_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.tenant().companyName.charAt(0));
  }
}
function LoginComponent_Conditional_4_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 21);
    \u0275\u0275element(2, "circle", 58)(3, "line", 59)(4, "line", 60);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  }
...
function LoginComponent_Conditional_4_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48);
    \u0275\u0275text(1, "\u05E0\u05D0 \u05DC\u05D4\u05D6\u05D9\u05DF \u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9");
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_Conditional_4_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 21);
    \u0275\u0275element(1, "path", 61)(2, "line", 62);
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_Conditional_4_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 21);
    \u0275\u0275element(1, "path", 63)(2, "circle", 22);
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_Conditional_4_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48);
    \u0275\u0275text(1, "\u05E0\u05D0 \u05DC\u05D4\u05D6\u05D9\u05DF \u05E1\u05D9\u05E1\u05DE\u05D4");
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(0, LoginComponent_Conditional_4_Conditional_0_Template, 1, 2, "img", 36)(1, LoginComponent_Conditional_4_Conditional_1_Template, 2, 1, "div", 37);
    \u0275\u0275elementStart(2, "div", 38);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h2", 39);
    \u0275\u0275text(5, "\u05DB\u05E0\u05D9\u05E1\u05D4 \u05DC\u05DE\u05E2\u05E8\u05DB\u05EA");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 40);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, LoginComponent_Conditional_4_Conditional_8_Template, 6, 1, "div", 41);
    \u0275\u0275elementStart(9, "form", 42);
    \u0275\u0275listener("ngSubmit", function LoginComponent_Conditional_4_Template_form_ngSubmit_9_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(15, "svg", 46);
    \u0275\u0275element(16, "path", 47);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(17, LoginComponent_Conditional_4_Conditional_17_Template, 2, 0, "div", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(18, "div", 49)(19, "label");
    \u0275\u0275text(20, "\u05E1\u05D9\u05E1\u05DE\u05D4");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(24, "rect", 51)(25, "path", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(26, "button", 53);
    \u0275\u0275listener("click", function LoginComponent_Conditional_4_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showPass.set(!ctx_r1.showPass()));
    });
    \u0275\u0275conditionalCreate(27, LoginComponent_Conditional_4_Conditional_27_Template, 3, 0, ":svg:svg", 21)(28, LoginComponent_Conditional_4_Conditional_28_Template, 3, 0, ":svg:svg", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(29, LoginComponent_Conditional_4_Conditional_29_Template, 2, 0, "div", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "button", 54)(31, "span", 55);
    \u0275\u0275text(32, "\u05DB\u05E0\u05D9\u05E1\u05D4 \u05DC\u05DE\u05E2\u05E8\u05DB\u05EA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "div", 56);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r1.tenant().logoUrl ? 0 : 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.tenant().systemName);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.tenant().promptText);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.error() ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("shake", ctx_r1.shake());
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(5);
    \u0275\u0275classProp("input-error", ctx_r1.form.get("username")?.invalid && ctx_r1.form.get("username")?.touched);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.form.get("username")?.invalid && ctx_r1.form.get("username")?.touched ? 17 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275classProp("input-error", ctx_r1.form.get("password")?.invalid && ctx_r1.form.get("password")?.touched);
    \u0275\u0275property("type", ctx_r1.showPass() ? "text" : "password");
    \u0275\u0275control();
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r1.showPass() ? 27 : 28);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.form.get("password")?.invalid && ctx_r1.form.get("password")?.touched ? 29 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("loading", ctx_r1.loading());
    \u0275\u0275property("disabled", ctx_r1.loading());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.tenant().copyright);
  }
}
var LoginComponent = class _LoginComponent {
  ...
  loadingTenant = signal(
    true,
    ...ngDevMode ? [{ debugName: "loadingTenant" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  tenantCode = signal(
    "",
    ...ngDevMode ? [{ debugName: "tenantCode" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  tenant = signal(
    null,
    ...ngDevMode ? [{ debugName: "tenant" }] : (
      /* istanbul ignore next */
      []
    )
  );
  constructor(fb, auth, router, route, tenantSvc) {
    this.fb = fb;
    this.auth = auth;
    this.router = router;
    this.route = route;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 73, vars: 7, consts: [[1, "login-page"], [1, "form-side"], [1, "splash"], [1, "no-tenant"], [1, "hero"], [1, "orb", "orb-brand"], [1, "orb", "orb-blue"], [1, "sf-logo-wrap"], [1, "sf-wordmark"], [1, "sf-squad"], [1, "sf-flow"], [1, "sf-tagline"], [1, "hero-body"], [1, "live-badge"], [1, "live-dot"], [1, "hero-title"], [1, "hero-sub"], [1, "hero-sub", "hero-sub-2"], [1, "hero-features"], [1, "feat"], [1, "feat-icon"], ["viewBox", "0 0 24 24"], ["cx", "12", "cy", "12", "r", "3"], ["d", "M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"], ["x", "2", "y", "3", "width", "20", "height", "14", "rx", "2"], ["d", "M8 21h8M12 17v4"], ["d", "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"], [1, "hero-cta-text"], [1, "hero-stats"], [1, "stat-item"], [1, "stat-num"], [1, "stat-lbl"], [1, "spinner-ring"], [1, "no-tenant-icon"], [1, "company-logo", 3, "src", "alt"], [1, "company-initials"], [1, "form-eyebrow"], [1, "form-title"], [1, "form-subtitle"], [1, "alert-error"], ["novalidate", "", 3, "ngSubmit", "formGroup"], [1, "form-group"], [1, "input-wrap"], ["type", "text", "formControlName", "username", "placeholder", "\u05D4\u05D6\u05DF \u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9", "autocomplete", "username"], ["viewBox", "0 0 24 24", 1, "fi"], ["d", "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"], [1, "field-error"], [1, "form-group", 2, "margin-bottom", "28px"], ["formControlName", "password", "placeholder", "\u05D4\u05D6\u05DF \u05E1\u05D9\u05E1\u05DE\u05D4", "autocomplete", "current-password", 3, "type"], ["x", "3", "y", "11", "width", "18", "height", "11", "rx", "2", "ry", "2"], ["d", "M7 11V7a5 5 0 0 1 10 0v4"], ["type", "button", 1, "toggle-pass", 3, "click"], ["type", "submit", 1, "btn-submit", 3, "disabled"], [1, "btn-text"], [1, "spinner"], [1, "form-footer"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], ["d", "M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"], ["x1", "1", "y1", "1", "x2", "23", "y2", "23"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(16, "AI Development Platform");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "div", 12)(18, "div", 13);
      \u0275\u0275element(19, "span", 14);
      \u0275\u0275text(20, " \u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05E4\u05E2\u05D9\u05DC\u05D9\u05DD ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "h1", 15);
      \u0275\u0275text(22, " \u05E4\u05D9\u05EA\u05D5\u05D7 \u05DE\u05D4\u05D9\u05E8 \u05D9\u05D5\u05EA\u05E8.");
      \u0275\u0275element(23, "br");
      \u0275\u0275text(24, " \u05E2\u05DD ");
      \u0275\u0275elementStart(25, "em");
      \u0275\u0275text(26, "\u05E6\u05D5\u05D5\u05EA AI");
      \u0275\u0275elementEnd();
      \u0275\u0275text(27, " \u05E9\u05E2\u05D5\u05D1\u05D3 \u05D1\u05E9\u05D1\u05D9\u05DC\u05DA. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "p", 16);
      \u0275\u0275text(29, " SQUADFLOW \u05DE\u05E1\u05E4\u05E7\u05EA \u05DC\u05D1\u05EA\u05D9 \u05EA\u05D5\u05DB\u05E0\u05D4 \u05D0\u05EA \u05D4\u05DB\u05DC\u05D9\u05DD \u05DC\u05D1\u05E0\u05D5\u05EA \u05DE\u05D5\u05E6\u05E8\u05D9\u05DD \u05D7\u05DB\u05DE\u05D9\u05DD \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05E6\u05D5\u05D5\u05EA \u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05E9\u05DE\u05E4\u05EA\u05D7\u05D9\u05DD, \u05D1\u05D5\u05D3\u05E7\u05D9\u05DD \u05D5\u05DE\u05E1\u05E4\u05E7\u05D9\u05DD \u05E7\u05D5\u05D3, \u05D1\u05D6\u05DE\u05DF \u05E9\u05D0\u05EA\u05D4 \u05DE\u05EA\u05DE\u05E7\u05D3 \u05D1\u05DC\u05E7\u05D5\u05D7\u05D5\u05EA. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "p", 17);
      \u0275\u0275text(31, " \u05D1\u05E0\u05D5\u05D9 \u05E2\u05DC \u05E0\u05D9\u05E1\u05D9\u05D5\u05DF \u05E9\u05DC 20 \u05E9\u05E0\u05D4 \u05D1\u05E4\u05D9\u05EA\u05D5\u05D7 \u05D0\u05E8\u05D2\u05D5\u05E0\u05D9, SQUADFLOW \u05D4\u05D5\u05E4\u05DB\u05EA \u05DB\u05DC \u05E8\u05E2\u05D9\u05D5\u05DF \u05DC\u05DE\u05D5\u05E6\u05E8 \u05E2\u05D5\u05D1\u05D3 \u2014 \u05D1\u05E9\u05D9\u05D8\u05D4 \u05D7\u05D5\u05D6\u05E8\u05EA, \u05DE\u05D4\u05D9\u05E8\u05D4 \u05D5\u05DC\u05DC\u05D0 \u05EA\u05DC\u05D5\u05EA \u05D1\u05D0\u05E0\u05E9\u05D9\u05DD \u05D1\u05D5\u05D3\u05D3\u05D9\u05DD. ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(39, "\u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05E9\u05E2\u05D5\u05D1\u05D3\u05D9\u05DD 24/7 \u2014 \u05DB\u05DC \u05D0\u05D7\u05D3 \u05D9\u05D5\u05D3\u05E2 \u05D0\u05EA \u05EA\u05E4\u05E7\u05D9\u05D3\u05D5, \u05D0\u05D9\u05DF \u05DB\u05E4\u05D9\u05DC\u05D5\u05D9\u05D5\u05EA \u05D5\u05D0\u05D9\u05DF \u05E2\u05E6\u05D9\u05E8\u05D5\u05EA");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(40, "div", 19)(41, "div", 20);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(42, "svg", 21);
      \u0275\u0275element(43, "rect", 24)(44, "path", 25);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(45, "span");
      \u0275\u0275text(46, "\u05DE\u05D3\u05E8\u05D9\u05E9\u05D5\u05EA \u05DC\u05E7\u05D5\u05D3 \u2014 \u05D4\u05E6\u05D5\u05D5\u05EA \u05DE\u05E4\u05EA\u05D7, \u05D1\u05D5\u05D3\u05E7 \u05D5\u05DE\u05E1\u05E4\u05E7 \u05D1\u05E1\u05E4\u05E8\u05D9\u05E0\u05D8 \u05D0\u05D7\u05D3");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(47, "div", 19)(48, "div", 20);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(49, "svg", 21);
      \u0275\u0275element(50, "path", 26)(51, "circle", 27)(52, "path", 28);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(53, "span");
      \u0275\u0275text(54, "\u05D4\u05E4\u05E8\u05D3\u05D4 \u05DE\u05DC\u05D0\u05D4 \u05D1\u05D9\u05DF \u05DC\u05E7\u05D5\u05D7\u05D5\u05EA \u2014 \u05DB\u05DC \u05D1\u05D9\u05EA \u05EA\u05D5\u05DB\u05E0\u05D4 \u05E2\u05DD \u05E6\u05D5\u05D5\u05EA \u05D5\u05E1\u05D1\u05D9\u05D1\u05D4 \u05E0\u05E4\u05E8\u05D3\u05D9\u05DD");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(55, "p", 29);
      \u0275\u0275text(56, "\u05D4\u05EA\u05D7\u05DC \u05D0\u05EA \u05D4\u05E1\u05E4\u05E8\u05D9\u05E0\u05D8 \u05D4\u05E8\u05D0\u05E9\u05D5\u05DF \u05E9\u05DC\u05DA \u05D4\u05D9\u05D5\u05DD.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(57, "div", 30)(58, "div", 31)(59, "span", 32);
      \u0275\u0275text(60, "\u221E");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(61, "span", 33);
      \u0275\u0275text(62, "\u05D9\u05DB\u05D5\u05DC\u05EA \u05E4\u05D9\u05EA\u05D5\u05D7");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(63, "div", 31)(64, "span", 32);
      \u0275\u0275text(65, "24/7");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(66, "span", 33);
      \u0275\u0275text(67, "\u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05D6\u05DE\u05D9\u05E0\u05D9\u05DD");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(68, "div", 31)(69, "span", 32);
      \u0275\u0275text(70, "10\xD7");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(71, "span", 33);
      \u0275\u0275text(72, "\u05DE\u05D4\u05D9\u05E8\u05D5\u05EA \u05E4\u05D9\u05EA\u05D5\u05D7");
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275styleProp("--brand", ctx.tenant()?.brandColor || "#C8472A");
      \u0275\u0275advance();
      \u0275\u0275classProp("visible", !ctx.loadingTenant());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loadingTenant() ? 2 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.loadingTenant() && ctx.noTenant() ? 3 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.loadingTenant() && !ctx.noTenant() && ctx.tenant() ? 4 : -1);
    }
  }, dependencies: [
    CommonModule,
    ReactiveFormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    ...
    args: [{ selector: "app-login", standalone: true, imports: [
      ...
      MatProgressSpinnerModule,
      NeuralNetComponent
    ], template: `<div class="login-page" [style.--brand]="tenant()?.brandColor || '#C8472A'">

  <!-- \u2550\u2550\u2550 FORM SIDE \u2014 \u05D9\u05DE\u05D9\u05DF \u2550\u2550\u2550 -->
  <div class="form-side" [class.visible]="!loadingTenant()">

    @if (loadingTenant()) {
      <div class="splash"><div class="spinner-ring"></div></div>
    }

    @if (!loadingTenant() && noTenant()) {
      <div class="no-tenant">
        <div class="no-tenant-icon">\u26A0</div>
        <h3>\u05E7\u05D9\u05E9\u05D5\u05E8 \u05DC\u05D0 \u05EA\u05E7\u05D9\u05DF</h3>
        <p>\u05E4\u05E0\u05D4 \u05DC\u05DE\u05E0\u05D4\u05DC \u05D4\u05DE\u05E2\u05E8\u05DB\u05EA \u05DC\u05E7\u05D1\u05DC\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8 \u05DB\u05E0\u05D9\u05E1\u05D4 \u05DC\u05D0\u05E8\u05D2\u05D5\u05DF \u05E9\u05DC\u05DA.</p>
      </div>
    }

    @if (!loadingTenant() && !noTenant() && tenant()) {
      @if (tenant()!.logoUrl) {
        <img [src]="tenant()!.logoUrl" [alt]="tenant()!.companyName" class="company-logo" />
      } @else {
        <div class="company-initials">{{ tenant()!.companyName.charAt(0) }}</div>
      }

      <div class="form-eyebrow">{{ tenant()!.systemName }}</div>
      <h2 class="form-title">\u05DB\u05E0\u05D9\u05E1\u05D4 \u05DC\u05DE\u05E2\u05E8\u05DB\u05EA</h2>
      <p class="form-subtitle">{{ tenant()!.promptText }}</p>
      ...
      <form [formGroup]="form" (ngSubmit)="submit()" novalidate [class.shake]="shake()">

        <div class="form-group">
          <label>\u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9</label>
          <div class="input-wrap">
            <input type="text" formControlName="username" placeholder="\u05D4\u05D6\u05DF \u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9" autocomplete="username"
                   [class.input-error]="form.get('username')?.invalid && form.get('username')?.touched" />
            <svg class="fi" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
          </div>
          @if (form.get('username')?.invalid && form.get('username')?.touched) {
            <div class="field-error">\u05E0\u05D0 \u05DC\u05D4\u05D6\u05D9\u05DF \u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9</div>
          }
        </div>
        ...
        <div class="form-group" style="margin-bottom:28px">
          ...
          <div class="input-wrap">
            ...
            <svg class="fi" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
          ...
          @if (form.get('password')?.invalid && form.get('password')?.touched) {
            <div class="field-error">\u05E0\u05D0 \u05DC\u05D4\u05D6\u05D9\u05DF \u05E1\u05D9\u05E1\u05DE\u05D4</div>
          }
        </div>
      ...
      <div class="form-footer">{{ tenant()!.copyright }}</div>
    }
  ...
  <div class="hero">
    ...
    <div class="sf-logo-wrap">
      <div class="sf-wordmark">
        <span class="sf-squad">SQUAD</span><span class="sf-flow">FLOW</span>
      </div>
      <div class="sf-tagline">AI Development Platform</div>
    </div>
    ...
    <div class="hero-body">
      ...
      <h1 class="hero-title">
        \u05E4\u05D9\u05EA\u05D5\u05D7 \u05DE\u05D4\u05D9\u05E8 \u05D9\u05D5\u05EA\u05E8.<br/>
        \u05E2\u05DD <em>\u05E6\u05D5\u05D5\u05EA AI</em> \u05E9\u05E2\u05D5\u05D1\u05D3 \u05D1\u05E9\u05D1\u05D9\u05DC\u05DA.
      </h1>

      <p class="hero-sub">
        SQUADFLOW \u05DE\u05E1\u05E4\u05E7\u05EA \u05DC\u05D1\u05EA\u05D9 \u05EA\u05D5\u05DB\u05E0\u05D4 \u05D0\u05EA \u05D4\u05DB\u05DC\u05D9\u05DD \u05DC\u05D1\u05E0\u05D5\u05EA \u05DE\u05D5\u05E6\u05E8\u05D9\u05DD \u05D7\u05DB\u05DE\u05D9\u05DD \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05E6\u05D5\u05D5\u05EA \u05E1\u05D5\u05DB\u05E0\u05D9 AI
        \u05E9\u05DE\u05E4\u05EA\u05D7\u05D9\u05DD, \u05D1\u05D5\u05D3\u05E7\u05D9\u05DD \u05D5\u05DE\u05E1\u05E4\u05E7\u05D9\u05DD \u05E7\u05D5\u05D3, \u05D1\u05D6\u05DE\u05DF \u05E9\u05D0\u05EA\u05D4 \u05DE\u05EA\u05DE\u05E7\u05D3 \u05D1\u05DC\u05E7\u05D5\u05D7\u05D5\u05EA.
      </p>

      <p class="hero-sub hero-sub-2">
        \u05D1\u05E0\u05D5\u05D9 \u05E2\u05DC \u05E0\u05D9\u05E1\u05D9\u05D5\u05DF \u05E9\u05DC 20 \u05E9\u05E0\u05D4 \u05D1\u05E4\u05D9\u05EA\u05D5\u05D7 \u05D0\u05E8\u05D2\u05D5\u05E0\u05D9, SQUADFLOW \u05D4\u05D5\u05E4\u05DB\u05EA \u05DB\u05DC \u05E8\u05E2\u05D9\u05D5\u05DF \u05DC\u05DE\u05D5\u05E6\u05E8 \u05E2\u05D5\u05D1\u05D3 \u2014
        \u05D1\u05E9\u05D9\u05D8\u05D4 \u05D7\u05D5\u05D6\u05E8\u05EA, \u05DE\u05D4\u05D9\u05E8\u05D4 \u05D5\u05DC\u05DC\u05D0 \u05EA\u05DC\u05D5\u05EA \u05D1\u05D0\u05E0\u05E9\u05D9\u05DD \u05D1\u05D5\u05D3\u05D3\u05D9\u05DD.
      </p>
      ...
      <div class="hero-features">
        <div class="feat">
          ...
          <span>\u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05E9\u05E2\u05D5\u05D1\u05D3\u05D9\u05DD 24/7 \u2014 \u05DB\u05DC \u05D0\u05D7\u05D3 \u05D9\u05D5\u05D3\u05E2 \u05D0\u05EA \u05EA\u05E4\u05E7\u05D9\u05D3\u05D5, \u05D0\u05D9\u05DF \u05DB\u05E4\u05D9\u05DC\u05D5\u05D9\u05D5\u05EA \u05D5\u05D0\u05D9\u05DF \u05E2\u05E6\u05D9\u05E8\u05D5\u05EA</span>
        </div>
        <div class="feat">
          <div class="feat-icon">
            <svg viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
          </div>
          <span>\u05DE\u05D3\u05E8\u05D9\u05E9\u05D5\u05EA \u05DC\u05E7\u05D5\u05D3 \u2014 \u05D4\u05E6\u05D5\u05D5\u05EA \u05DE\u05E4\u05EA\u05D7, \u05D1\u05D5\u05D3\u05E7 \u05D5\u05DE\u05E1\u05E4\u05E7 \u05D1\u05E1\u05E4\u05E8\u05D9\u05E0\u05D8 \u05D0\u05D7\u05D3</span>
        </div>
        <div class="feat">
          <div class="feat-icon">
            <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>
          </div>
          <span>\u05D4\u05E4\u05E8\u05D3\u05D4 \u05DE\u05DC\u05D0\u05D4 \u05D1\u05D9\u05DF \u05DC\u05E7\u05D5\u05D7\u05D5\u05EA \u2014 \u05DB\u05DC \u05D1\u05D9\u05EA \u05EA\u05D5\u05DB\u05E0\u05D4 \u05E2\u05DD \u05E6\u05D5\u05D5\u05EA \u05D5\u05E1\u05D1\u05D9\u05D1\u05D4 \u05E0\u05E4\u05E8\u05D3\u05D9\u05DD</span>
        </div>
      </div>

      <p class="hero-cta-text">\u05D4\u05EA\u05D7\u05DC \u05D0\u05EA \u05D4\u05E1\u05E4\u05E8\u05D9\u05E0\u05D8 \u05D4\u05E8\u05D0\u05E9\u05D5\u05DF \u05E9\u05DC\u05DA \u05D4\u05D9\u05D5\u05DD.</p>
    </div>

    <div class="hero-stats">
      <div class="stat-item">
        <span class="stat-num">\u221E</span>
        <span class="stat-lbl">\u05D9\u05DB\u05D5\u05DC\u05EA \u05E4\u05D9\u05EA\u05D5\u05D7</span>
      </div>
      <div class="stat-item">
        <span class="stat-num">24/7</span>
        <span class="stat-lbl">\u05E1\u05D5\u05DB\u05E0\u05D9 AI \u05D6\u05DE\u05D9\u05E0\u05D9\u05DD</span>
      </div>
      <div class="stat-item">
        <span class="stat-num">10\xD7</span>
        <span class="stat-lbl">\u05DE\u05D4\u05D9\u05E8\u05D5\u05EA \u05E4\u05D9\u05EA\u05D5\u05D7</span>
      </div>
    </div>
...
`, styles: ['/* src/app/features/login/login.component.scss */\n:host {\n  display: block;\n  height: 100vh;\n}\n.login-page {\n  display: flex;\n  flex-direction: row;\n  height: 100vh;\n  direction: rtl;\n  overflow: hidden;\n  --brand: #C8472A;\n  --brand-dark: #9e3420;\n  --brand-mid: #e05a38;\n  --brand-light: #fff2ee;\n  --text: #1e1b18;\n  --muted: #7a7060;\n  --border: #e8e0da;\n  --bg: #faf8f6;\n}\n.form-side {\n  width: 22%;\n  min-width: 320px;\n  max-width: 420px;\n  flex-shrink: 0;\n  background: #fff;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  padding: 40px 32px;\n  box-shadow: 4px 0 32px rgba(0, 0, 0, 0.07);\n  position: relative;\n  z-index: 1;\n  opacity: 0;\n  transform: translateX(20px);\n  transition: opacity 0.45s ease, transform 0.45s ease;\n}\n.form-side.visible {\n  opacity: 1;\n  transform: translateX(0);\n}\n.company-logo {\n  height: 80px;\n  max-width: 200px;\n  object-fit: contain;\n  margin-bottom: 28px;\n  display: block;\n}\n.company-initials {\n  width: 64px;\n  height: 64px;\n  border-radius: 14px;\n  background:\n    linear-gradient(\n      135deg,\n      var(--brand),\n      var(--brand-mid));\n  color: #fff;\n  font-size: 2rem;\n  font-weight: 800;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 28px;\n}\n.form-eyebrow {\n  font-size: 0.73rem;\n  font-weight: 800;\n  color: var(--brand);\n  text-transform: uppercase;\n  letter-spacing: 0.1em;\n  margin-bottom: 8px;\n}\n.form-title {\n  font-size: 1.7rem;\n  font-weight: 800;\n  color: var(--text);\n  margin: 0 0 8px;\n  line-height: 1.2;\n}\n.form-subtitle {\n  font-size: 0.88rem;\n  color: var(--muted);\n  margin-bottom: 28px;\n  line-height: 1.5;\n}\n.alert-error {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  background: var(--brand-light);\n  border: 1.5px solid #f9c0b0;\n  border-radius: 10px;\n  padding: 11px 14px;\n  font-size: 0.86rem;\n  font-weight: 600;\n  color: var(--brand-dark);\n  margin-bottom: 18px;\n}\n.alert-error svg {\n  width: 17px;\n  height: 17px;\n  flex-shrink: 0;\n  fill: none;\n  stroke: currentColor;\n  stroke-width: 2;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n}\n.form-group {\n  margin-bottom: 18px;\n}\nlabel {\n  display: block;\n  font-size: 0.74rem;\n  font-weight: 800;\n  color: #5a5248;\n  margin-bottom: 7px;\n  text-transform: uppercase;\n  letter-spacing: 0.07em;\n}\n.input-wrap {\n  position: relative;\n}\n.input-wrap svg.fi {\n  position: absolute;\n  right: 13px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 16px;\n  height: 16px;\n  stroke: #c4b8b0;\n  fill: none;\n  stroke-width: 2;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n  pointer-events: none;\n  transition: stroke 0.2s;\n}\n.input-wrap:focus-within svg.fi {\n  stroke: var(--brand);\n}\ninput[type=text],\ninput[type=password] {\n  width: 100%;\n  padding: 12px 42px 12px 42px;\n  background: var(--bg);\n  border: 1.5px solid var(--border);\n  border-radius: 12px;\n  font-size: 0.93rem;\n  color: var(--text);\n  font-family:\n    "Noto Sans Hebrew",\n    Arial,\n    sans-serif;\n  outline: none;\n  transition:\n    border-color 0.2s,\n    background 0.2s,\n    box-shadow 0.2s;\n  direction: rtl;\n}\ninput[type=text]::placeholder,\ninput[type=password]::placeholder {\n  color: #c0b8b2;\n}\ninput[type=text]:focus,\ninput[type=password]:focus {\n  border-color: var(--brand);\n  background: #fff;\n  box-shadow: 0 0 0 3px rgba(200, 71, 42, 0.1);\n}\ninput[type=text].input-error,\ninput[type=password].input-error {\n  border-color: var(--brand);\n  box-shadow: 0 0 0 3px rgba(200, 71, 42, 0.1);\n}\n.toggle-pass {\n  position: absolute;\n  left: 11px;\n  top: 50%;\n  transform: translateY(-50%);\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 4px;\n  color: #c4b8b0;\n  display: flex;\n  align-items: center;\n  transition: color 0.2s;\n}\n.toggle-pass:hover {\n  color: var(--brand);\n}\n.toggle-pass svg {\n  width: 17px;\n  height: 17px;\n  stroke: currentColor;\n  fill: none;\n  stroke-width: 2;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n}\n.field-error {\n  font-size: 0.76rem;\n  color: var(--brand);\n  font-weight: 600;\n  margin-top: 5px;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.btn-submit {\n  width: 100%;\n  padding: 14px;\n  background:\n    linear-gradient(\n      135deg,\n      var(--brand) 0%,\n      var(--brand-mid) 100%);\n  color: #fff;\n  font-family:\n    "Noto Sans Hebrew",\n    Arial,\n    sans-serif;\n  font-size: 1rem;\n  font-weight: 800;\n  border: none;\n  border-radius: 12px;\n  cursor: pointer;\n  transition:\n    opacity 0.2s,\n    transform 0.15s,\n    box-shadow 0.2s;\n  box-shadow: 0 4px 18px rgba(200, 71, 42, 0.3);\n  position: relative;\n  overflow: hidden;\n}\n.btn-submit::after {\n  content: "";\n  position: absolute;\n  inset: 0;\n  background:\n    linear-gradient(\n      135deg,\n      rgba(255, 255, 255, 0.18) 0%,\n      transparent 55%);\n  pointer-events: none;\n}\n.btn-submit:hover:not(:disabled) {\n  opacity: 0.92;\n  transform: translateY(-1px);\n  box-shadow: 0 6px 24px rgba(200, 71, 42, 0.4);\n}\n.btn-submit:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n  transform: none;\n}\n.btn-submit .btn-text {\n  display: block;\n}\n.btn-submit .spinner {\n  display: none;\n  width: 20px;\n  height: 20px;\n  margin: 0 auto;\n  border: 2.5px solid rgba(255, 255, 255, 0.3);\n  border-top-color: #fff;\n  border-radius: 50%;\n  animation: spin 0.65s linear infinite;\n}\n.btn-submit.loading .btn-text {\n  display: none;\n}\n.btn-submit.loading .spinner {\n  display: block;\n}\n.form-footer {\n  text-align: center;\n  margin-top: 28px;\n  padding-top: 20px;\n  border-top: 1px solid var(--border);\n  font-size: 0.73rem;\n  color: #b0a898;\n}\n.splash {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n}\n.spinner-ring {\n  width: 36px;\n  height: 36px;\n  border: 3px solid var(--border);\n  border-top-color: var(--brand);\n  border-radius: 50%;\n  animation: spin 0.7s linear infinite;\n}\n.no-tenant {\n  text-align: center;\n}\n.no-tenant .no-tenant-icon {\n  font-size: 3rem;\n  margin-bottom: 12px;\n}\n.no-tenant h3 {\n  font-size: 1.1rem;\n  color: var(--text);\n  margin: 0 0 8px;\n}\n.no-tenant p {\n  font-size: 0.85rem;\n  color: var(--muted);\n  line-height: 1.6;\n}\n.hero {\n  flex: 1;\n  background:\n    linear-gradient(\n      160deg,\n      #0a0f1e 0%,\n      #0f1c35 50%,\n      #0d1628 100%);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  padding: 56px 64px 48px;\n  position: relative;\n  overflow: hidden;\n}\n.orb {\n  position: absolute;\n  border-radius: 50%;\n  filter: blur(80px);\n  pointer-events: none;\n}\n.orb-brand {\n  width: 400px;\n  height: 400px;\n  background: rgba(200, 71, 42, 0.2);\n  bottom: -100px;\n  right: -100px;\n}\n.orb-blue {\n  width: 300px;\n  height: 300px;\n  background: rgba(56, 100, 200, 0.18);\n  top: -60px;\n  left: 40px;\n}\n.sf-logo-wrap {\n  position: relative;\n  z-index: 2;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  margin-bottom: 48px;\n}\n.sf-wordmark {\n  display: flex;\n  align-items: baseline;\n  line-height: 1;\n  direction: ltr;\n}\n.sf-squad {\n  font-family: "Exo 2", sans-serif;\n  font-weight: 800;\n  font-size: 2.6rem;\n  letter-spacing: -1px;\n  color: #fff;\n}\n.sf-flow {\n  font-family: "Exo 2", sans-serif;\n  font-weight: 300;\n  font-size: 2.6rem;\n  letter-spacing: 2px;\n  color: #00E5FF;\n}\n.sf-tagline {\n  font-family: "Share Tech Mono", monospace;\n  font-size: 0.68rem;\n  letter-spacing: 4px;\n  color: #4A6FA5;\n  text-transform: uppercase;\n  margin-top: 6px;\n}\n.hero-body {\n  position: relative;\n  z-index: 2;\n}\n.live-badge {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n  background: rgba(255, 255, 255, 0.07);\n  border: 1px solid rgba(255, 255, 255, 0.13);\n  color: rgba(255, 255, 255, 0.85);\n  font-size: 0.72rem;\n  font-weight: 700;\n  padding: 5px 14px;\n  border-radius: 20px;\n  margin-bottom: 28px;\n  -webkit-backdrop-filter: blur(8px);\n  backdrop-filter: blur(8px);\n}\n.live-dot {\n  width: 7px;\n  height: 7px;\n  border-radius: 50%;\n  background: #4ade80;\n  box-shadow: 0 0 6px #4ade80;\n  animation: liveBlink 1.5s ease-in-out infinite;\n}\n.hero-title {\n  font-size: 2.6rem;\n  font-weight: 800;\n  color: #fff;\n  line-height: 1.2;\n  margin-bottom: 18px;\n  text-shadow: 0 2px 20px rgba(0, 0, 0, 0.3);\n}\n.hero-title em {\n  font-style: normal;\n  color: var(--brand);\n}\n.hero-sub {\n  font-size: 0.95rem;\n  color: rgba(255, 255, 255, 0.55);\n  line-height: 1.75;\n  margin-bottom: 16px;\n  max-width: 400px;\n}\n.hero-sub-2 {\n  font-size: 0.85rem;\n  color: rgba(255, 255, 255, 0.4);\n  line-height: 1.7;\n  margin-bottom: 32px;\n  max-width: 400px;\n}\n.hero-cta-text {\n  font-size: 1.3rem;\n  font-weight: 800;\n  color: var(--brand);\n  margin-top: 28px;\n  margin-bottom: 0;\n  line-height: 1.2;\n}\n.hero-features {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n}\n.feat {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n  color: rgba(255, 255, 255, 0.8);\n  font-size: 0.88rem;\n  font-weight: 500;\n}\n.feat-icon {\n  width: 38px;\n  height: 38px;\n  border-radius: 10px;\n  background: rgba(200, 71, 42, 0.15);\n  border: 1px solid rgba(200, 71, 42, 0.3);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n}\n.feat-icon svg {\n  width: 17px;\n  height: 17px;\n  stroke: #f87a5a;\n  fill: none;\n  stroke-width: 2;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n}\n.hero-stats {\n  display: flex;\n  position: relative;\n  z-index: 2;\n  padding-top: 28px;\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.stat-item {\n  flex: 1;\n  text-align: center;\n  padding: 0 8px;\n  border-left: 1px solid rgba(255, 255, 255, 0.08);\n}\n.stat-item:last-child {\n  border-left: none;\n}\n.stat-num {\n  font-size: 1.6rem;\n  font-weight: 800;\n  color: #fff;\n  display: block;\n  line-height: 1;\n  margin-bottom: 5px;\n}\n.stat-lbl {\n  font-size: 0.72rem;\n  font-weight: 500;\n  color: rgba(255, 255, 255, 0.45);\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n@keyframes liveBlink {\n  0%, 100% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.3;\n  }\n}\n@keyframes shake {\n  0%, 100% {\n    transform: translateX(0);\n  }\n  20% {\n    transform: translateX(-6px);\n  }\n  40% {\n    transform: translateX(6px);\n  }\n  60% {\n    transform: translateX(-4px);\n  }\n  80% {\n    transform: translateX(4px);\n  }\n}\n.shake {\n  animation: shake 0.4s ease;\n}\n@media (max-width: 860px) {\n  .hero {\n    display: none;\n  }\n  .form-side {\n    width: 100%;\n    max-width: none;\n    padding: 48px 28px;\n    box-shadow: none;\n  }\n}\n/*# sourceMappingURL=login.component.css.map */\n'] }]
  }], () => [{ type: FormBuilder }, { type: AuthService }, { type: Router }, { type: ActivatedRoute }, { type: TenantService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/features/login/login.component.ts", lineNumber: 30 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-DCC2C5ZP.js.map
