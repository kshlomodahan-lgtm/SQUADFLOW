...
function AuditComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "a", 23)(2, "mat-icon");
    \u0275\u0275text(3, "tune");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " \u05E1\u05D5\u05D2\u05D9 \u05E4\u05E2\u05D5\u05DC\u05D5\u05EA ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "a", 24)(6, "mat-icon");
    \u0275\u0275text(7, "schema");
    \u0275\u0275elementEnd();
...
function AuditComponent_Conditional_47_ng_template_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 42)(2, "div", 43);
    \u0275\u0275text(3, "\u05DC\u05E4\u05E0\u05D9 \u05D4\u05E9\u05D9\u05E0\u05D5\u05D9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "pre", 44);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 42)(7, "div", 43);
    \u0275\u0275text(8, "\u05D0\u05D7\u05E8\u05D9 \u05D4\u05E9\u05D9\u05E0\u05D5\u05D9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "pre", 45);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AuditComponent_Conditional_47_ng_template_1_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275conditionalCreate(1, AuditComponent_Conditional_47_ng_template_1_Conditional_1_Template, 11, 2, "div", 39)(2, AuditComponent_Conditional_47_ng_template_1_Conditional_2_Template, 4, 0, "div", 40);
    \u0275\u0275conditionalCreate(3, AuditComponent_Conditional_47_ng_template_1_Conditional_3_Template, 2, 1, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AuditComponent_Conditional_47_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 46)(1, "button", 47);
    \u0275\u0275listener("click", function AuditComponent_Conditional_47_ng_template_3_Template_button_click_1_listener() {
...
function AuditComponent_Conditional_47_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_9_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, AuditComponent_Conditional_47_ng_template_9_Conditional_2_Template, 2, 1, "span", 52);
  }
  if (rf & 2) {
...
function AuditComponent_Conditional_47_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "kendo-grid", 26);
    \u0275\u0275listener("pageChange", function AuditComponent_Conditional_47_Template_kendo_grid_pageChange_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onPageChange($event));
    });
    \u0275\u0275template(1, AuditComponent_Conditional_47_ng_template_1_Template, 4, 2, "ng-template", 27);
    \u0275\u0275elementStart(2, "kendo-grid-column", 28);
    \u0275\u0275template(3, AuditComponent_Conditional_47_ng_template_3_Template, 3, 7, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "kendo-grid-column", 30);
    \u0275\u0275template(5, AuditComponent_Conditional_47_ng_template_5_Template, 2, 1, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "kendo-grid-column", 31);
    \u0275\u0275template(7, AuditComponent_Conditional_47_ng_template_7_Template, 2, 2, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "kendo-grid-column", 32);
    \u0275\u0275template(9, AuditComponent_Conditional_47_ng_template_9_Template, 3, 2, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "kendo-grid-column", 33);
    \u0275\u0275template(11, AuditComponent_Conditional_47_ng_template_11_Template, 2, 1, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "kendo-grid-column", 34);
    \u0275\u0275template(13, AuditComponent_Conditional_47_ng_template_13_Template, 2, 3, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "kendo-grid-column", 35);
    \u0275\u0275template(15, AuditComponent_Conditional_47_ng_template_15_Template, 5, 2, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "kendo-grid-column", 36);
    \u0275\u0275template(17, AuditComponent_Conditional_47_ng_template_17_Template, 3, 4, "ng-template", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "kendo-grid-messages", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AuditComponent = class _AuditComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditComponent, selectors: [["app-audit"]], viewQuery: function AuditComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(45, AuditComponent_Conditional_45_Template, 2, 1, "div", 20);
      \u0275\u0275conditionalCreate(46, AuditComponent_Conditional_46_Template, 4, 1, "div", 21);
      \u0275\u0275conditionalCreate(47, AuditComponent_Conditional_47_Template, 19, 25, "kendo-grid", 22);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.error() ? 46 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(!ctx.loading() && !ctx.error() ? 47 : -1);
    }
  }, dependencies: [
    CommonModule,
    NgClass,
...
//# sourceMappingURL=chunk-DOJ62EMA.js.map
