...
app.use('/api/permission-codes',  require('./routes/permission-codes'));
app.use('/api/perm-assignments',  require('./routes/perm-assignments'));
app.use('/api/entity-links',      require('./routes/entity-links'));
app.use('/api/content-groups',    require('./routes/content-groups'));
